...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var hashedPassword1, hashedPassword2, alice, bob;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.hash("alice", 10)];
                case 1:
                    hashedPassword1 = _a.sent();
                    return [4 /*yield*/, bcrypt_1.default.hash('bob', 10)];
                case 2:
                    hashedPassword2 = _a.sent();
                    return [4 /*yield*/, client_1.prisma.user.upsert({
